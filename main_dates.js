...
d3.json("data/graph_with_dates.json")
    .then(function(data) { // load in data
        ...
        console.log(typeof dataset.birthIndexingDate);
        console.log(dataset.birthIndexingDate instanceof Date);       
        ...
        const svg = d3.select("#dates-network")
            .append("svg")
        ...
        const node = svg.append("g")
                        ...
                        .join("circle")
                        .attr("r", 4)
                        .attr("stroke", d => color(d.deathIndexingDate))
                        .attr("fill", d => color(d.birthIndexingDate))
                        .on("mouseover", function(event, d) {
                            ...
                            div.html(`
                                    ...
                                    Birth indexing date: ${d.birthIndexingDate ?? "Unknown"}<br>
                                    Death indexing date: ${d.deathIndexingDate ?? "Unknown"}
                                `)
...
// formats indexed date value to standard form
